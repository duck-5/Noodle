"""
Files routes — listing, download proxy, and recent files from local CSV cache.
"""
...
@router.get("/download")
async def proxy_download(url: str = Query(...), current_user: dict = Depends(get_current_user)):
